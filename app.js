...
const axios = require('axios'); // 👈 Required for sending messages
            ...
            if (
                ...
                if (messageData.type === 'text') {
                    ...
                    // Menu Selection Logic
                        ...
                        await sendReply(senderPhone, "✅ آپ نے *سیل مین سے متعلق شکایت* کا انتخاب کیا ہے۔\n\nبراہ کرم اپنی شکایت تفصیل سے لکھ کر بھیجیں۔");
                    }
                    else if (textMessage === "2") {
                        await sendReply(senderPhone, "✅ آپ نے *ڈسٹری بیوٹر سے متعلق شکایت* کا انتخاب کیا ہے۔\n\nبراہ کرم اپنی شکایت تفصیل سے لکھ کر بھیجیں۔");
                    }
                    else if (textMessage === "3") {
                        await sendReply(senderPhone, "✅ آپ نے *سٹاک کی کوالٹی/ قیمت یا بل* کا انتخاب کیا ہے۔\n\nبراہ کرم مسئلہ تفصیل سے بیان کریں۔");
                    }
                    else if (textMessage === "4") {
                        await sendReply(senderPhone, "✅ آپ نے *سٹاک آرڈر* کا انتخاب کیا ہے۔\n\nبراہ کرم اپنا آرڈر تفصیل سے لکھ کر بھیجیں۔");
                    }
                }
            }
        }
